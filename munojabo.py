...
"""
munojabo.py is a simple jabber-bot designed to be called by munin[1] if any values are not within
the configured safe margins. Please see the README for documentation on how to configure munin to
use this script. This script was written by Mathias Ertl <mati@fsinf.at>.
...
group.add_option('--graph', help='The graph that has a warning/critical condition. This is the '
...
cl = MuNoJaBoConnection(config, options.jid, text.strip())
if cl.connect():
